module.exports = {
  ...
  faq: {
	...
	a1: 'Actifit is a Health-Focused Social Dapp That Rewards Your Everyday Activity! Using Actifit mobile app on android / iphone allows you to earn crypto token rewards via auto-tracking your everyday activity. Read more about Actifit here: <a href="https://actifit.io/whitepaper/Actifit_White_Paper.pdf">https://actifit.io/whitepaper/Actifit_White_Paper.pdf</a>',
	q2: 'Is the app available for Android and iOS?',
	a2: 'Yes! Actifit is available for download for both platforms. To download on your platform, follow the links below:<br/>Android: <a href="https://links.actifit.io/android">https://links.actifit.io/android</a><br/>iOS: <a href="https://links.actifit.io/ios">https://links.actifit.io/ios</a>',
	q3: 'How to Join Actifit?',
	a3: 'If you already have an account on Hive blockchain, you can use that same account name Actifit.<br/>If not, simply head over to <a href="https://actifit.io/signup">https://actifit.io/signup</a> , and follow the instructions to sign-up.<br/>More info is available on our video tutorials:<br/><li>on youtube <a href="https://www.youtube.com/watch?v=2CsvW-mqEs4">https://www.youtube.com/watch?v=2CsvW-mqEs4</a> </li><li>or on 3speak <a href="https://3speak.tv/watch?v=actifit-3speak/whngpmwx">https://3speak.tv/watch?v=actifit-3speak/whngpmwx</a></li>',
	q4: 'I am an Actifit user now but how can I benefit from this app?',
	a4: 'Actifit is here to provide you the motivation to raise your lifestyle to a healthier level, by creating the social and reward dynamic. Via Actifit, you join a vibrant and active community that is health and fitness oriented, but also earn token rewards including AFIT, STEEM, HIVE, BLURT, SPORTS Tokens and much more.<br/>Actifit users are known amongst each other as Actifitters :)',
	q5: 'How to post on Actifit?',
	a5: 'All you need is your mobile, Actifit fitness App, and an account on Actifit/HIVE.<br/>Upon reaching the minimum amount of 5000 steps or more, use your username and private posting key (for the first time), fill the necessary fields and send your post away!<br/>Note that if you didn’t reach your target, you can still post but you won’t be rewarded.',
	...
	q7: 'Can I use my smart watch/wearable to sync data to Actifit?',
	a7: 'Yes, but it also depends on your smartwatch and phone model. Currently Actifit supports syncing your activity data from any Fitbit watch. On android devices this is the sole smart watch currently supported.<br/>For iOS users, they have many more options, as they can sync from their Apple watch, or any of the thousands of devices that sync back to apple watch.',
	q8: 'How do I earn AFIT tokens?',
	a8: 'Actifit records your activity on a daily basis. Your activity count resets at midnight (although you can always post your activity count the next day by using the “yesterday” option in the dAPP).<br/>Keep in mind that you need to reach at least 5000 steps to get rewarded.<br/>Another way to earn tokens is by delegating part of your SP/HP to the @actifit account and upvoting other Actifit user posts (each upvote will result in extra Actifit tokens in your wallet!)<br/>To learn more about maximizing your AFIT rewards, check out this tutorial:<br/><li>on youtube <a href="https://www.youtube.com/watch?v=2CsvW-mqEs4">https://www.youtube.com/watch?v=2CsvW-mqEs4</a> </li><li>or on 3speak <a href="https://3speak.tv/watch?v=actifit-3speak/whngpmwx">https://3speak.tv/watch?v=actifit-3speak/whngpmwx</a></li>',
	q9: 'How can I use my AFIT?',
	a9: 'Accumulating AFIT will increase your ranking and that will allow you to earn more rewards on your activity reports<br/>You can use your AFIT to purchase virtual gadgets or real products from our Actifit Market <a href="https://actifit.io/market">https://actifit.io/market</a> .<br/>You can also exchange your AFIT token for extra vote rewards',
	q10: 'Can I exchange my AFIT into other crypto?',
	a10: 'Yes, by transferring your earned AFIT to supported exchanges (hive-engine.com or steem-engine.net), you can actually exchange them to supported tokens on these exchanges. <br/>As we expand to BSC, you will be able to exchange them to available tokens on BSC.',
	...
	q12: 'What is AFITX?',
	a12: 'AFITX is a special benefits token for Actifit users & AFIT token holders. Holding this token enables users to:<li> Move extra daily AFIT tokens to Hive Engine and Steem Engine</li><li>Increases user rank</li><li>Increases post rewards via our different rewarded tokens</li><li>Receive priority when exchanging AFIT for HIVE/STEEM/BLURT upvotes</li><li>Participate in contests</li><br/>As Binance Smart Chain and DeFi support is launched, AFITX will be used as a reward token and governance token on this platform.',
	q13: 'How do I earn AFITX tokens?',
	a13: 'You can earn AFITX tokens when you add liquidity in the AFIT/HIVE pool on Tribaldex and the AFITX liquidity pools on BSC.',
	...
	a15: 'Delegators receive two types of rewards:<br/><li>Daily AFIT token rewards, from a pool of 100,000 AFIT tokens distributed proportionally amongst delegators</li><li>-and-</li><li>Weekly 5% beneficiary reward from Actifit posts, in HIVE/HBD and STEEM/SBD, proportionally amongst delegators.</li>',
	q16: 'How can I delegate to Actifit?',
	a16: 'To delegate, head over to your wallet <a href="https://actifit.io/wallet">https://actifit.io/wallet</a>, set the amount and set target as @actifit account (default), use your private active key and you’re good to go.<br/>Make sure you leave at least 15 HP/SP left on your account.<br/>Attention! If you plan to increase your delegation, you need to actually use the new total amount as the delegation amount, and not only the increased amount. Otherwise only the new amount will be used, and the remaining will be undelegated.',
	q17: 'How can I transfer AFIT to other Actifit accounts?',
	a17: 'AFIT tokens can be transferred from your Profile page in the wallet. After selecting the Tip AFIT button, enter the user name and the amount of AFIT to be sent.',
	q18: 'Why should I increase my user rank?',
	a18: 'Actifit innovated its own ranking system to qualify its users, and increase the rewards of those with a higher rank. User rank determines 25% of the total reward value. The ranking system is scaled from 0 (lowest) to 100 (highest), and is affected by a multitude of factors, while making it a dynamic system, as follows:<br/><li>Amount of Delegated Steem/HIVE Power (SP/HP)</li><li>Amount of Held AFIT Tokens</li><li>Total Activity Rewarded</li><li>Last 10 Days Activity Count</li><li>Amount of AFITX held on hive-engine.com, steem-engine.net and moving forward on BSC</li><br/>You can check more details about your rank on <a href="https://actifit.io/userrank">https://actifit.io/userrank</a> ',
	q19: 'How do I contact you if my question isn’t answered here?',
	a19: 'You can always contact us on one of the following<br/><li>Facebook: <a href="https://www.facebook.com/Actifit.fitness/">https://www.facebook.com/Actifit.fitness/</a> </li><li>Instagram: <a href="https://www.instagram.com/actifit.fitness/">https://www.instagram.com/actifit.fitness/</a> </li><li>Twitter: <a href="https://www.twitter.com/Actifit_fitness">https://www.twitter.com/Actifit_fitness</a> </li><li>Telegram: <a href="https://t.me/actifit">https://t.me/actifit</a> </li><li>Discord: <a href="https://links.actifit.io/discord">https://links.actifit.io/discord</a> </li><li>Youtube:  <a href="https://www.youtube.com/channel/UCNHxAGO79rXI7Hdiikwnqtw">https://www.youtube.com/channel/UCNHxAGO79rXI7Hdiikwnqtw</a> </li><li>Medium: <a href="https://medium.com/@actifit.fitness">https://medium.com/@actifit.fitness</a> </li>',
